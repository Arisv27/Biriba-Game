...
### Optional Node Server (multiplayer-ready)
...
npm start
```
The server serves the `public/` files and enables Socket.IO connectivity. Access the game at the printed local URL (defaults to http://localhost:3000).
